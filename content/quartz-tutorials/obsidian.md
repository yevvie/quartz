...
### New Vault
If you don't have an existing Vault, [download Obsidian](https://obsidian.md/) and create a new Vault in the `/content` folder that you created and cloned during the [setup](quartz-tutorials/setup.md) step.
...
> 👀 Step 4: [Preview Quartz Changes](quartz-tutorials/preview%20changes.md)
